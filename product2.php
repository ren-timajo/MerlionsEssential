...
<center>
    <div class="company">
        <img src="BondPaper.jpg" title="Bondpaper" id="lugu">
    </div>     
    <div class="slogan">
        <h1>BondPaper - Php 2.00</h1>
    </div>
    <div class="desc">
        <p>&nbsp &nbsp Bond paper is commonly used in laser and inkjet printers, copiers, and other office machines, and it is also used for writing and drawing by artists and designers. Its high quality and professional appearance make it a popular choice for a variety of applications, including business reports, resumes, legal documents, and official correspondence.
        </p>
    </div>
    <div class="link">
        <a href='order.php?product="bond"&quan="0"&name=""&email=""&add=""&num=""'>Order Now</a>
    </div>
    <div class="return">
        <a href="./">Back</a>
    </div>
